...
namespace BetterFrostLegion.Common.Systems
{
    ...
    public class SummonSnowmanSystem : ModSystem
    {
        public static bool SummonSnowman = false;
        ...
        {
            SummonSnowman = tag.ContainsKey("DownedSnowmanPrime");
