...
{
    internal class HardenedSnow : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Hardened Snow");
            Tooltip.SetDefault("You'd expect it to melt, but it doesn't."); // The (English) text shown below your item's name
